...
enum opt_code
{
  ...
  OPT_Werror_maybe_reset = 230,              /* -Werror-maybe-reset */
  ...
  OPT_Wframe_larger_than_ = 251,             /* -Wframe-larger-than= */
  OPT_Wfree_nonheap_object = 252,            /* -Wfree-nonheap-object */
  OPT_Wfunction_elimination = 253,           /* -Wfunction-elimination */
  OPT_Whiding = 254,                         /* -Whiding */
  OPT_Wignored_qualifiers = 255,             /* -Wignored-qualifiers */
  OPT_Wimplicit = 256,                       /* -Wimplicit */
  OPT_Wimplicit_function_declaration = 257,  /* -Wimplicit-function-declaration */
  OPT_Wimplicit_int = 258,                   /* -Wimplicit-int */
  OPT_Wimplicit_interface = 259,             /* -Wimplicit-interface */
  OPT_Wimplicit_procedure = 260,             /* -Wimplicit-procedure */
  /* OPT_Wimport = 261, */                   /* -Wimport */
  OPT_Wincompatible_pointer_types = 262,     /* -Wincompatible-pointer-types */
  OPT_Windirect_static = 263,                /* -Windirect-static */
  OPT_Winherited_variadic_ctor = 264,        /* -Winherited-variadic-ctor */
  OPT_Winit_self = 265,                      /* -Winit-self */
  OPT_Winline = 266,                         /* -Winline */
  OPT_Wint_conversion = 267,                 /* -Wint-conversion */
  OPT_Wint_to_pointer_cast = 268,            /* -Wint-to-pointer-cast */
  OPT_Wintf_annotation = 269,                /* -Wintf-annotation */
  OPT_Wintf_non_inherited = 270,             /* -Wintf-non-inherited */
  OPT_Wintrinsic_shadow = 271,               /* -Wintrinsic-shadow */
  OPT_Wintrinsics_std = 272,                 /* -Wintrinsics-std */
  OPT_Winvalid_memory_model = 273,           /* -Winvalid-memory-model */
  OPT_Winvalid_offsetof = 274,               /* -Winvalid-offsetof */
  OPT_Winvalid_pch = 275,                    /* -Winvalid-pch */
  OPT_Wjavadoc = 276,                        /* -Wjavadoc */
  OPT_Wjump_misses_init = 277,               /* -Wjump-misses-init */
  OPT_Wl_ = 278,                             /* -Wl, */
  /* OPT_Wlarger_than_ = 279, */             /* -Wlarger-than- */
  OPT_Wlarger_than_ = 280,                   /* -Wlarger-than= */
  OPT_Wline_truncation = 281,                /* -Wline-truncation */
  OPT_Wliteral_suffix = 282,                 /* -Wliteral-suffix */
  OPT_Wlocal_hiding = 283,                   /* -Wlocal-hiding */
  OPT_Wlogical_not_parentheses = 284,        /* -Wlogical-not-parentheses */
  OPT_Wlogical_op = 285,                     /* -Wlogical-op */
  OPT_Wlong_long = 286,                      /* -Wlong-long */
  OPT_Wmain = 287,                           /* -Wmain */
  OPT_Wmasked_catch_block = 288,             /* -Wmasked-catch-block */
  OPT_Wmaybe_uninitialized = 289,            /* -Wmaybe-uninitialized */
  OPT_Wmemset_transposed_args = 290,         /* -Wmemset-transposed-args */
  OPT_Wmissing_braces = 291,                 /* -Wmissing-braces */
  OPT_Wmissing_declarations = 292,           /* -Wmissing-declarations */
  OPT_Wmissing_field_initializers = 293,     /* -Wmissing-field-initializers */
  /* OPT_Wmissing_format_attribute = 294, */ /* -Wmissing-format-attribute */
  OPT_Wmissing_include_dirs = 295,           /* -Wmissing-include-dirs */
  /* OPT_Wmissing_noreturn = 296, */         /* -Wmissing-noreturn */
  OPT_Wmissing_parameter_type = 297,         /* -Wmissing-parameter-type */
  OPT_Wmissing_prototypes = 298,             /* -Wmissing-prototypes */
  /* OPT_Wmudflap = 299, */                  /* -Wmudflap */
  OPT_Wmultichar = 300,                      /* -Wmultichar */
  OPT_Wnarrowing = 301,                      /* -Wnarrowing */
  OPT_Wnested_externs = 302,                 /* -Wnested-externs */
  OPT_Wnls = 303,                            /* -Wnls */
  OPT_Wno_effect_assign = 304,               /* -Wno-effect-assign */
  OPT_Wnoexcept = 305,                       /* -Wnoexcept */
  OPT_Wnon_template_friend = 306,            /* -Wnon-template-friend */
  OPT_Wnon_virtual_dtor = 307,               /* -Wnon-virtual-dtor */
  OPT_Wnonnull = 308,                        /* -Wnonnull */
  /* OPT_Wnormalized = 309, */               /* -Wnormalized */
  OPT_Wnormalized_ = 310,                    /* -Wnormalized= */
  OPT_Wnull = 311,                           /* -Wnull */
  OPT_Wodr = 312,                            /* -Wodr */
  OPT_Wold_style_cast = 313,                 /* -Wold-style-cast */
  OPT_Wold_style_declaration = 314,          /* -Wold-style-declaration */
  OPT_Wold_style_definition = 315,           /* -Wold-style-definition */
  OPT_Wopenmp_simd = 316,                    /* -Wopenmp-simd */
  OPT_Wout_of_date = 317,                    /* -Wout-of-date */
  OPT_Wover_ann = 318,                       /* -Wover-ann */
  OPT_Woverflow = 319,                       /* -Woverflow */
  OPT_Woverlength_strings = 320,             /* -Woverlength-strings */
  OPT_Woverloaded_virtual = 321,             /* -Woverloaded-virtual */
  OPT_Woverride_init = 322,                  /* -Woverride-init */
  OPT_Wp_ = 323,                             /* -Wp, */
  OPT_Wpacked = 324,                         /* -Wpacked */
  OPT_Wpacked_bitfield_compat = 325,         /* -Wpacked-bitfield-compat */
  OPT_Wpadded = 326,                         /* -Wpadded */
  OPT_Wparam_assign = 327,                   /* -Wparam-assign */
  OPT_Wparentheses = 328,                    /* -Wparentheses */
  OPT_Wpedantic = 329,                       /* -Wpedantic */
  OPT_Wpkg_default_method = 330,             /* -Wpkg-default-method */
  OPT_Wpmf_conversions = 331,                /* -Wpmf-conversions */
  OPT_Wpointer_arith = 332,                  /* -Wpointer-arith */
  OPT_Wpointer_sign = 333,                   /* -Wpointer-sign */
  OPT_Wpointer_to_int_cast = 334,            /* -Wpointer-to-int-cast */
  ...
  OPT_fhonour_copts = 698,                   /* -fhonour-copts */
  ...
  OPT_iremap = 1132,                         /* -iremap */
  OPT_isysroot = 1133,                       /* -isysroot */
  OPT_isystem = 1134,                        /* -isystem */
  OPT_iwithprefix = 1135,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1136,              /* -iwithprefixbefore */
  OPT_k8 = 1137,                             /* -k8 */
  OPT_l = 1138,                              /* -l */
  OPT_lang_asm = 1139,                       /* -lang-asm */
  OPT_mabi_ = 1140,                          /* -mabi= */
  OPT_mabort_on_noreturn = 1141,             /* -mabort-on-noreturn */
  OPT_mandroid = 1142,                       /* -mandroid */
  OPT_mapcs = 1143,                          /* -mapcs */
  OPT_mapcs_float = 1144,                    /* -mapcs-float */
  OPT_mapcs_frame = 1145,                    /* -mapcs-frame */
  OPT_mapcs_reentrant = 1146,                /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 1147,              /* -mapcs-stack-check */
  OPT_march_ = 1148,                         /* -march= */
  OPT_marm = 1149,                           /* -marm */
  OPT_masm_syntax_unified = 1150,            /* -masm-syntax-unified */
  OPT_mbig_endian = 1151,                    /* -mbig-endian */
  OPT_mbionic = 1152,                        /* -mbionic */
  OPT_mcallee_super_interworking = 1153,     /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 1154,     /* -mcaller-super-interworking */
  OPT_mcpu_ = 1155,                          /* -mcpu= */
  OPT_mfix_cortex_m3_ldrd = 1156,            /* -mfix-cortex-m3-ldrd */
  OPT_mflip_thumb = 1157,                    /* -mflip-thumb */
  OPT_mfloat_abi_ = 1158,                    /* -mfloat-abi= */
  OPT_mfp16_format_ = 1159,                  /* -mfp16-format= */
  OPT_mfpu_ = 1160,                          /* -mfpu= */
  OPT_mglibc = 1161,                         /* -mglibc */
  /* OPT_mhard_float = 1162, */              /* -mhard-float */
  OPT_mlittle_endian = 1163,                 /* -mlittle-endian */
  OPT_mlong_calls = 1164,                    /* -mlong-calls */
  OPT_mmusl = 1165,                          /* -mmusl */
  OPT_mneon_for_64bits = 1166,               /* -mneon-for-64bits */
  OPT_mnew_generic_costs = 1167,             /* -mnew-generic-costs */
  OPT_mold_rtx_costs = 1168,                 /* -mold-rtx-costs */
  OPT_mpic_data_is_text_relative = 1169,     /* -mpic-data-is-text-relative */
  OPT_mpic_register_ = 1170,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1171,            /* -mpoke-function-name */
  OPT_mprint_tune_info = 1172,               /* -mprint-tune-info */
  OPT_mrestrict_it = 1173,                   /* -mrestrict-it */
  OPT_msched_prolog = 1174,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1175,               /* -msingle-pic-base */
  OPT_mslow_flash_data = 1176,               /* -mslow-flash-data */
  /* OPT_msoft_float = 1177, */              /* -msoft-float */
  OPT_mstructure_size_boundary_ = 1178,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1179,                         /* -mthumb */
  OPT_mthumb_interwork = 1180,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1181,                  /* -mtls-dialect= */
  OPT_mtp_ = 1182,                           /* -mtp= */
  OPT_mtpcs_frame = 1183,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1184,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1185,                         /* -mtune= */
  OPT_muclibc = 1186,                        /* -muclibc */
  OPT_munaligned_access = 1187,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1188,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1189,      /* -mvectorize-with-neon-quad */
  OPT_mword_relocations = 1190,              /* -mword-relocations */
  OPT_n = 1191,                              /* -n */
  OPT_no_canonical_prefixes = 1192,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1193,              /* -no-integrated-cpp */
  OPT_nocpp = 1194,                          /* -nocpp */
  OPT_nodefaultlibs = 1195,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1196,                   /* -nostartfiles */
  OPT_nostdinc = 1197,                       /* -nostdinc */
  OPT_nostdinc__ = 1198,                     /* -nostdinc++ */
  OPT_nostdlib = 1199,                       /* -nostdlib */
  OPT_o = 1200,                              /* -o */
  OPT_p = 1201,                              /* -p */
  OPT_pass_exit_codes = 1202,                /* -pass-exit-codes */
  /* OPT_pedantic = 1203, */                 /* -pedantic */
  OPT_pedantic_errors = 1204,                /* -pedantic-errors */
  OPT_pg = 1205,                             /* -pg */
  OPT_pie = 1206,                            /* -pie */
  OPT_pipe = 1207,                           /* -pipe */
  OPT_posix = 1208,                          /* -posix */
  OPT_print_file_name_ = 1209,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1210,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1211,          /* -print-multi-directory */
  OPT_print_multi_lib = 1212,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1213,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1214,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1215,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1216,               /* -print-prog-name= */
  OPT_print_search_dirs = 1217,              /* -print-search-dirs */
  OPT_print_sysroot = 1218,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1219,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1220,                        /* -profile */
  OPT_pthread = 1221,                        /* -pthread */
  OPT_quiet = 1222,                          /* -quiet */
  OPT_r = 1223,                              /* -r */
  OPT_rdynamic = 1224,                       /* -rdynamic */
  OPT_remap = 1225,                          /* -remap */
  OPT_s = 1226,                              /* -s */
  OPT_s_bc_abi = 1227,                       /* -s-bc-abi */
  OPT_save_temps = 1228,                     /* -save-temps */
  OPT_save_temps_ = 1229,                    /* -save-temps= */
  OPT_shared = 1230,                         /* -shared */
  OPT_shared_libgcc = 1231,                  /* -shared-libgcc */
  /* OPT_specs = 1232, */                    /* -specs */
  OPT_specs_ = 1233,                         /* -specs= */
  OPT_static = 1234,                         /* -static */
  OPT_static_libasan = 1235,                 /* -static-libasan */
  OPT_static_libgcc = 1236,                  /* -static-libgcc */
  OPT_static_libgcj = 1237,                  /* -static-libgcj */
  OPT_static_libgfortran = 1238,             /* -static-libgfortran */
  OPT_static_libgo = 1239,                   /* -static-libgo */
  OPT_static_liblsan = 1240,                 /* -static-liblsan */
  OPT_static_libmpx = 1241,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1242,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1243,               /* -static-libstdc++ */
  OPT_static_libtsan = 1244,                 /* -static-libtsan */
  OPT_static_libubsan = 1245,                /* -static-libubsan */
  /* OPT_std_c__03 = 1246, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1247, */                /* -std=c++0x */
  OPT_std_c__11 = 1248,                      /* -std=c++11 */
  OPT_std_c__14 = 1249,                      /* -std=c++14 */
  /* OPT_std_c__17 = 1250, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1251, */                /* -std=c++1y */
  OPT_std_c__1z = 1252,                      /* -std=c++1z */
  OPT_std_c__98 = 1253,                      /* -std=c++98 */
  OPT_std_c11 = 1254,                        /* -std=c11 */
  /* OPT_std_c1x = 1255, */                  /* -std=c1x */
  /* OPT_std_c89 = 1256, */                  /* -std=c89 */
  OPT_std_c90 = 1257,                        /* -std=c90 */
  OPT_std_c99 = 1258,                        /* -std=c99 */
  /* OPT_std_c9x = 1259, */                  /* -std=c9x */
  OPT_std_f2003 = 1260,                      /* -std=f2003 */
  OPT_std_f2008 = 1261,                      /* -std=f2008 */
  OPT_std_f2008ts = 1262,                    /* -std=f2008ts */
  OPT_std_f95 = 1263,                        /* -std=f95 */
  OPT_std_gnu = 1264,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1265, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1266, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1267,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1268,                    /* -std=gnu++14 */
  /* OPT_std_gnu__17 = 1269, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1270, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1271,                    /* -std=gnu++1z */
  OPT_std_gnu__98 = 1272,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1273,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1274, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1275, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1276,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1277,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1278, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1279, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1280,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1281, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1282, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1283, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1284,                     /* -std=legacy */
  OPT_symbolic = 1285,                       /* -symbolic */
  OPT_t = 1286,                              /* -t */
  OPT_time = 1287,                           /* -time */
  OPT_time_ = 1288,                          /* -time= */
  OPT_tno_android_cc = 1289,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1290,                 /* -tno-android-ld */
  OPT_traditional = 1291,                    /* -traditional */
  OPT_traditional_cpp = 1292,                /* -traditional-cpp */
  OPT_trigraphs = 1293,                      /* -trigraphs */
  OPT_u = 1294,                              /* -u */
  OPT_undef = 1295,                          /* -undef */
  OPT_v = 1296,                              /* -v */
  OPT_version = 1297,                        /* -version */
  OPT_w = 1298,                              /* -w */
  OPT_wrapper = 1299,                        /* -wrapper */
  OPT_x = 1300,                              /* -x */
  OPT_z = 1301,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
