/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/home/wangyaliang/workspace/tina/out/tulip-d1/compile_dir/toolchain/gcc-linaro-5.2-2015.11-2/gcc/config/aarch64/aarch64.md'.  */
...
{
  if (c >= CONSTRAINT_S && c <= CONSTRAINT_Dd)
    return;
